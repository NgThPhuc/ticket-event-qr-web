...
Backend đã hỗ trợ **2 phương thức checkout** và **tự động hủy order sau 15 phút**.

---

## ⏰ Order Expiration (15 phút)

> **QUAN TRỌNG**: Order sẽ tự động bị hủy sau 15 phút nếu chưa thanh toán!

Response khi tạo order sẽ có thêm field `expires_at`:
```json
{
  "id": "...",
...
### Frontend cần:
1. **Hiển thị countdown timer** - "Đơn hàng hết hạn sau: 14:59"
2. **Redirect khi hết hạn** - Về trang sự kiện với thông báo
